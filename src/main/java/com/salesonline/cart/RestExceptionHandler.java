package com.salesonline.cart;

import com.fasterxml.jackson.annotation.JsonFormat;
import com.salesonline.cart.apierror.ApiError;
import com.salesonline.cart.controller.utils.ControllerMapper;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleIllegalArgumentException(IllegalArgumentException ex,
        ...
        apiError.setMessage(String.format("Invaled credentials.Please check your data."));
        apiError.setBackendMessage(ex.getMessage());
        writeLog(apiError, ex);
        return buildResponseEntity(apiError);
    ...
    public ResponseEntity<Object> handleProductException(ItemException e) {
